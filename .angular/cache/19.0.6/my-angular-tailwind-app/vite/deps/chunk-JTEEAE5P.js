...
var _PreconnectLinkChecker = class _PreconnectLinkChecker {
  constructor() {
    ...
    __publicField(this, "isServer", isPlatformServer(inject(PLATFORM_ID)));
    /**
...
var _NgOptimizedImage = class _NgOptimizedImage {
  constructor() {
    ...
    __publicField(this, "isServer", isPlatformServer(inject(PLATFORM_ID)));
    __publicField(this, "preloadLinkCreator", inject(PreloadLinkCreator));
    // a LCP image observer - should be injected only in the dev mode
    __publicField(this, "lcpObserver", ngDevMode ? this.injector.get(LCPImageObserver) : null);
    /**
...
@angular/common/fesm2022/common.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JTEEAE5P.js.map
