import {
  Title
} from "./chunk-V3GIKWCN.js";
import "./chunk-6N2O5C7H.js";
import {
  DOCUMENT,
...
var Scroll = class {
  constructor(routerEvent, position, anchor) {
    __publicField(this, "routerEvent");
    __publicField(this, "position");
    __publicField(this, "anchor");
    __publicField(this, "type", EventType.Scroll);
...
function stringifyEvent(routerEvent) {
  ...
  switch (routerEvent.type) {
    case EventType.ActivationEnd:
      return "ActivationEnd(path: '".concat(((_a2 = routerEvent.snapshot.routeConfig) == null ? void 0 : _a2.path) || "", "')");
    case EventType.ActivationStart:
      return "ActivationStart(path: '".concat(((_b2 = routerEvent.snapshot.routeConfig) == null ? void 0 : _b2.path) || "", "')");
...
var _RouterOutlet = class _RouterOutlet {
  constructor() {
     ...
     */
    __publicField(this, "routerOutletData", input(void 0));
...
var _NavigationTransitions = class _NavigationTransitions {
  constructor() {
     ...
     * @internal
     */
    __publicField(this, "afterPreactivation", () => of(void 0));
    /** @internal */
...
var _Router = class _Router {
  constructor() {
    ...
    __publicField(this, "config", (_b = (_a = inject(ROUTES, {
      optional: true
...
var _RouterLink = class _RouterLink {
  constructor(router, route, tabIndexAttribute, renderer, el, locationStrategy) {
    ...
    /** @internal */
    __publicField(this, "onChanges", new Subject());
    /**
     * Passed to {@link Router#createUrlTree} as part of the
     * `UrlCreationOptions`.
...
var _RouterLinkActive = class _RouterLinkActive {
  constructor(router, element, renderer, cdr, link) {
     ...
     */
    __publicField(this, "routerLinkActiveOptions", {
      exact: false
    });
    /**
     ...
     * ```
     */
    __publicField(this, "isActiveChange", new EventEmitter());
    this.router = router;
...
var _RouterScroller = class _RouterScroller {
  ...
  constructor(urlSerializer, transitions, viewportScroller, zone, options = {}) {
    ...
    __publicField(this, "lastSource", "imperative");
    ...
    providers = [{
      ...
      useFactory: () => {
        ...
        return () => router.events.subscribe((e) => {
          var _a2, _b2;
          (_a2 = console.group) == null ? void 0 : _a2.call(console, "Router Event: ".concat(e.constructor.name));
